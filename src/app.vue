...
const showPending = computed(() => isPending.value)
    ...
    <main>
        ...
        <transition
            ...
            <div
                ...
                aria-label="Loading">
                <div
                    class="flex items-center gap-3 border border-(--border) bg-(--card)/85 px-5 py-4 shadow-sm">
                    <span
                        class="h-5 w-5 animate-spin rounded-full border-2 border-(--primary) border-t-transparent"
                        aria-hidden="true" />
                    <span
                        class="small-caps font-sans-dm text-xs text-(--primary)">
                        Loading
                    </span>
                </div>
            </div>
